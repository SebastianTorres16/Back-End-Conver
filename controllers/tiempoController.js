const { converTiempo } = require('../operaciones/tiempo');

const converTiempoController = (req, res) => {
    try {
        ...
        const resultado = converTiempo(valor, unidadOrigen, unidadDestino);
